...
这个仓库的 Skill 本体在 `skill/academic-paper-translator/`。把这个目录安装到 Codex skills 目录后，对 Codex 说：
...
Skill 会指导 Codex 使用 `skill/academic-paper-translator/scripts/` 里的工具完成提取、分块、检查和合并。
